...
@Component({
   selector : "app-d_sample_list",
   templateUrl : "d_sample_list.component.html",
   styleUrls : ["d_sample_list.component.css"],
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["sampled_sample_list"])
export class DSampleListComponent extends BaseControlComponent implements OnInit {
